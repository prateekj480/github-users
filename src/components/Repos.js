...
const Repos = () => {
  ...
  const languages = repos.reduce((total, item) => {
    ...
    else total[language] = { label: language, value: total[language].value + 1, stars: total[language].stars + stargazers_count }
    return total
  }, {})
  ...
  const mostStars = Object.values(stars).sort((a, b) => b.value - a.value).slice(0, 5)
  const mostForks = Object.values(forks).sort((a, b) => b.value - a.value).slice(0, 5)
